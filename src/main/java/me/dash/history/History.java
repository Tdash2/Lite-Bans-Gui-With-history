...
public class History extends JavaPlugin {
    ...
    public void onEnable() {
        this
                ...
                .database = new Database(getConfig().getString("name"), getConfig().getString("password"), getConfig().getString("database"), getConfig().getString("host"), getConfig().getInt("port"));
    ...
    public Inventory getPlayerHistory(UUID id) {
        ...
        for (int i = 0; i < user.getHistoryTypes().size(); i++) {
            ...
            builder.setLore(new String[] { " - " + ChatColor.RED + "Type: " + type.name(), " - " + ChatColor.RED + "Active: " + type
                    .isActive(), " - " + ChatColor.RED + "Reason: " + type
                    .getReason(), " - " + ChatColor.RED + "Occurred: " + df
                    .format(Long.valueOf(type.getOccurred())), " - " + ChatColor.RED + "Expiring: " + sec
                    .format(Long.valueOf(type.getExpiring())), " - " + ChatColor.RED + "Issued by: " + type
                    .getExecutor() });
    ...
    public void pickServer(String PlayerName, String Ban_reson, Player csender, String Time) {
        Player player = csender;
        if (player.hasPermission("Gui.punish")) {
            Gui guiii = new Gui((Plugin)this, 3, "Ban " + PlayerName + " on what servers");
            ...
            GuiItem guiItemm = new GuiItem(itemmi, event -> {
                ...
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), bcmd + " " + PlayerName + " --sender=" + csender.getName() + " --sender-uuid=" + csender.getUniqueId() + " " + Time + " server:" + n1i + " " + Ban_reson);
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "Smite " + PlayerName);
            });
            paneei.addItem(guiItemm);
            guiii.addPane((Pane)paneei);
            ...
            GuiItem guiItemm1 = new GuiItem(itemm1, event -> {
                player.closeInventory();
                String bcmd = getConfig().getString("Ban_Command");
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), bcmd + " " + PlayerName + " --sender=" + csender.getName() + " --sender-uuid=" + csender.getUniqueId() + " " + Time + " server:" + n2 + " " + Ban_reson);
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "Smite " + PlayerName);
            });
            panee1.addItem(guiItemm1);
            guiii.addPane((Pane)panee1);
            ...
            GuiItem guiItemm2 = new GuiItem(itemm2, event -> {
                player.closeInventory();
                String bcmd = getConfig().getString("Ban_Command");
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), bcmd + " " + PlayerName + " --sender=" + csender.getName() + " --sender-uuid=" + csender.getUniqueId() + " " + Time + " " + Ban_reson);
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "Smite " + PlayerName);
            });
            panee2.addItem(guiItemm2);
            guiii.addPane((Pane)panee2);
            String n32 = "Back";
            ...
            GuiItem guiItemm22 = new GuiItem(itemm22, event -> {
                player.closeInventory();
                pickBanTime(PlayerName, Ban_reson, csender);
            });
            panee22.addItem(guiItemm22);
            guiii.addPane((Pane)panee22);
    ...
    public void pickBanTime(String PlayerName, String Ban_reson, Player csender) {
        Player player = csender;
        if (player.hasPermission("Gui.punish")) {
            Gui guii = new Gui((Plugin)this, 3, "Ban " + PlayerName + " for " + Ban_reson);
            ...
            GuiItem guiItemm = new GuiItem(itemm, event -> {
                player.closeInventory();
                banTime1(PlayerName, Ban_reson, player);
            });
            panee.addItem(guiItemm);
            guii.addPane((Pane)panee);
            ...
            GuiItem guiItemm1 = new GuiItem(itemm1, event -> {
                player.closeInventory();
                banTime2(PlayerName, Ban_reson, player);
            });
            panee1.addItem(guiItemm1);
            guii.addPane((Pane)panee1);
            ...
            GuiItem guiItemm2 = new GuiItem(itemm2, event -> {
                player.closeInventory();
                banTime3(PlayerName, Ban_reson, player);
            });
            panee2.addItem(guiItemm2);
            guii.addPane((Pane)panee2);
            ...
            GuiItem guiItemm3 = new GuiItem(itemm3, event -> {
                player.closeInventory();
                banTime4(PlayerName, Ban_reson, player);
            });
            panee3.addItem(guiItemm3);
            guii.addPane((Pane)panee3);
            ...
            GuiItem guiItemm4 = new GuiItem(itemm4, event -> {
                player.closeInventory();
                banTime5(PlayerName, Ban_reson, player);
            });
            panee4.addItem(guiItemm4);
            guii.addPane((Pane)panee4);
    ...
    public void pickMuteTime(String PlayerName, String Ban_reson, Player csender) {
        Player player = csender;
        if (player.hasPermission("Gui.punish")) {
            Gui guii = new Gui((Plugin)this, 3, "Mute " + PlayerName + " for " + Ban_reson);
            String n1 = getConfig().getString("Time_1");
            String l1 = getConfig().getString("Lore_1");
            String[] strArrayrr = { ChatColor.RESET + l1 };
            OutlinePane panee = new OutlinePane(2, 1, 9, 3);
            ...
            GuiItem guiItemm = new GuiItem(itemm, event -> {
                player.closeInventory();
                muteTime1(PlayerName, Ban_reson, player);
            });
            panee.addItem(guiItemm);
            guii.addPane((Pane)panee);
            String n2 = getConfig().getString("Time_2");
            ...
            GuiItem guiItemm1 = new GuiItem(itemm1, event -> {
                player.closeInventory();
                muteTime2(PlayerName, Ban_reson, player);
            });
            panee1.addItem(guiItemm1);
            guii.addPane((Pane)panee1);
            String n3 = getConfig().getString("Time_3");
            ...
            GuiItem guiItemm2 = new GuiItem(itemm2, event -> {
                player.closeInventory();
                muteTime3(PlayerName, Ban_reson, player);
            });
            panee2.addItem(guiItemm2);
            guii.addPane((Pane)panee2);
            String n4 = getConfig().getString("Time_4");
            ...
            GuiItem guiItemm3 = new GuiItem(itemm3, event -> {
                player.closeInventory();
                muteTime4(PlayerName, Ban_reson, player);
            });
            panee3.addItem(guiItemm3);
            guii.addPane((Pane)panee3);
            String n5 = getConfig().getString("Time_5");
            ...
            GuiItem guiItemm4 = new GuiItem(itemm4, event -> {
                player.closeInventory();
                muteTime5(PlayerName, Ban_reson, player);
            });
            panee4.addItem(guiItemm4);
            guii.addPane((Pane)panee4);
            String Reason_6 = "Back";
    ...
    public void banTime1(String PlayerName, String Ban_reson, Player csender) {
        if (perms.playerHas("world", PlayerName, "gui.no")) {
            ...
            if (player.getName().equalsIgnoreCase(PlayerName)) {
                ...
                if (player.hasPermission("Gui.time.1")) {
                    String bcmd = getConfig().getString("Ban_Command");
                    pickServer(PlayerName, Ban_reson, player, b1);
                } else {
    ...
    public void banTime2(String PlayerName, String Ban_reson, Player csender) {
        if (perms.playerHas("world", PlayerName, "gui.no")) {
            Player player = csender;
            player.sendMessage(ChatColor.RED + "You cannot ban this player");
        } else {
            ...
            if (player.getName().equalsIgnoreCase(PlayerName)) {
                ...
                if (player.hasPermission("Gui.time.2")) {
                    String bcmd = getConfig().getString("Ban_Command");
                    pickServer(PlayerName, Ban_reson, player, b2);
                } else {
                    player.sendMessage(ChatColor.RED + "You Don't have permission");
                }
            }
    ...
    public void banTime3(String PlayerName, String Ban_reson, Player csender) {
        if (perms.playerHas("world", PlayerName, "gui.no")) {
            Player player = csender;
            player.sendMessage(ChatColor.RED + "You cannot ban this player");
        } else {
            ...
            if (player.getName().equalsIgnoreCase(PlayerName)) {
                player.sendMessage(ChatColor.RED + "You Cannot Ban Your Self");
            } else if (player.hasPermission("Gui.time.3")) {
                String b3 = getConfig().getString("Ban_Time_3");
                String bcmd = getConfig().getString("Ban_Command");
                pickServer(PlayerName, Ban_reson, player, b3);
            } else {
                player.sendMessage(ChatColor.RED + "You Don't have permission");
            }
        }
    ...
    public void banTime4(String PlayerName, String Ban_reson, Player csender) {
        if (perms.playerHas("world", PlayerName, "gui.no")) {
            Player player = csender;
            player.sendMessage(ChatColor.RED + "You cannot ban this player");
        } else {
            ...
            if (player.getName().equalsIgnoreCase(PlayerName)) {
                player.sendMessage(ChatColor.RED + "You Cannot Ban Your Self");
            } else if (player.hasPermission("Gui.time.4")) {
                String b4 = getConfig().getString("Ban_Time_4");
                String bcmd = getConfig().getString("Ban_Command");
                pickServer(PlayerName, Ban_reson, player, b4);
            } else {
                player.sendMessage(ChatColor.RED + "You Don't have permission");
            }
        }
    ...
    public void banTime5(String PlayerName, String Ban_reson, Player csender) {
        if (perms.playerHas("world", PlayerName, "gui.no")) {
            Player player = csender;
            player.sendMessage(ChatColor.RED + "You cannot ban this player");
        } else {
            ...
            if (player.getName().equalsIgnoreCase(PlayerName)) {
                player.sendMessage(ChatColor.RED + "You Cannot Ban Your Self");
            } else if (player.hasPermission("Gui.time.5")) {
                String b5 = getConfig().getString("Ban_Time_5");
                String bcmd = getConfig().getString("Ban_Command");
                pickServer(PlayerName, Ban_reson, player, b5);
            } else {
                player.sendMessage(ChatColor.RED + "You Don't have permission");
            }
        }
    ...
    public void muteTime1(String PlayerName, String Ban_reson, Player csender) {
        if (perms.playerHas("world", PlayerName, "gui.no")) {
            Player player = csender;
            player.sendMessage(ChatColor.RED + "You cannot ban this player");
        } else {
            ...
            if (player.getName().equalsIgnoreCase(PlayerName)) {
                ...
                if (player.hasPermission("Gui.time.1")) {
                    ...
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), mcmd + " " + PlayerName + " --sender=" + csender.getName() + " --sender-uuid=" + csender.getUniqueId() + " " + b1 + " " + Ban_reson);
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "Smite " + PlayerName);
                } else {
                    player.sendMessage(ChatColor.RED + "You Don't have permission");
                }
    ...
    public void muteTime2(String PlayerName, String Ban_reson, Player csender) {
        if (perms.playerHas("world", PlayerName, "gui.no")) {
            Player player = csender;
            ...
            if (player.getName().equalsIgnoreCase(PlayerName)) {
                ...
                if (player.hasPermission("Gui.time.2")) {
                    String mcmd = getConfig().getString("Mute_Command");
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), mcmd + " " + PlayerName + " --sender=" + csender.getName() + " --sender-uuid=" + csender.getUniqueId() + " " + b2 + " " + Ban_reson);
                    Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "Smite " + PlayerName);
                } else {
                    player.sendMessage(ChatColor.RED + "You Don't have permission");
                }
    ...
    public void muteTime3(String PlayerName, String Ban_reson, Player csender) {
        if (perms.playerHas("world", PlayerName, "gui.no")) {
            Player player = csender;
            player.sendMessage(ChatColor.RED + "You cannot mute this player");
        } else {
            ...
            if (player.getName().equalsIgnoreCase(PlayerName)) {
                ...
                String b3 = getConfig().getString("Ban_Time_3");
                String mcmd = getConfig().getString("Mute_Command");
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), mcmd + " " + PlayerName + " --sender=" + csender.getName() + " --sender-uuid=" + csender.getUniqueId() + " " + b3 + " " + Ban_reson);
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "Smite " + PlayerName);
            } else {
                player.sendMessage(ChatColor.RED + "You Don't have permission");
            }
    ...
    public void muteTime4(String PlayerName, String Ban_reson, Player csender) {
        if (perms.playerHas("world", PlayerName, "gui.no")) {
            Player player = csender;
            player.sendMessage(ChatColor.RED + "You cannot mute this player");
        } else {
            ...
            if (player.getName().equalsIgnoreCase(PlayerName)) {
                ...
                String b4 = getConfig().getString("Ban_Time_4");
                String mcmd = getConfig().getString("Mute_Command");
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), mcmd + " " + PlayerName + " --sender=" + csender.getName() + " --sender-uuid=" + csender.getUniqueId() + " " + b4 + " " + Ban_reson);
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "Smite " + PlayerName);
            }
        }
    }

    public void muteTime5(String PlayerName, String Ban_reson, Player csender) {
        if (perms.playerHas("world", PlayerName, "gui.no")) {
            Player player = csender;
            player.sendMessage(ChatColor.RED + "You cannot mute this player");
        } else {
            ...
            if (player.getName().equalsIgnoreCase(PlayerName)) {
                ...
                String b5 = getConfig().getString("Ban_Time_5");
                String mcmd = getConfig().getString("Mute_Command");
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), mcmd + " " + PlayerName + " --sender=" + csender.getName() + " --sender-uuid=" + csender.getUniqueId() + " " + b5 + " " + Ban_reson);
                Bukkit.dispatchCommand((CommandSender)Bukkit.getConsoleSender(), "Smite " + PlayerName);
            } else {
                player.sendMessage(ChatColor.RED + "You Don't have permission");
            }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (command.getName().equals("newban"))
            if (args.length > 0) {
                ...
                if (player.hasPermission("Gui.punish.ban")) {
                    Gui gui = new Gui((Plugin)this, 5, "Ban: " + args[0]);
                    ...
                    GuiItem guiItem = new GuiItem(item, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_1, player);
                    });
                    ...
                    GuiItem guiItem1 = new GuiItem(item1, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_2, player);
                    });
                    pane1.addItem(guiItem1);
                    gui.addPane((Pane)pane1);
                    ...
                    GuiItem guiItem2 = new GuiItem(item2, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_3, player);
                    });
                    pane2.addItem(guiItem2);
                    gui.addPane((Pane)pane2);
                    ...
                    GuiItem guiItem3 = new GuiItem(item3, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_4, player);
                    });
                    pane3.addItem(guiItem3);
                    gui.addPane((Pane)pane3);
                    ...
                    GuiItem guiItem4 = new GuiItem(item4, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_5, player);
                    });
                    pane4.addItem(guiItem4);
                    gui.addPane((Pane)pane4);
                    ...
                    GuiItem guiItem5 = new GuiItem(item5, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_6, player);
                    });
                    pane5.addItem(guiItem5);
                    gui.addPane((Pane)pane5);
                    ...
                    GuiItem guiItem6 = new GuiItem(item6, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_7, player);
                    });
                    pane6.addItem(guiItem6);
                    gui.addPane((Pane)pane6);
                    ...
                    GuiItem guiItem7 = new GuiItem(item7, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_8, player);
                    });
                    pane7.addItem(guiItem7);
                    gui.addPane((Pane)pane7);
                    ...
                    GuiItem guiItem8 = new GuiItem(item8, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_9, player);
                    });
                    pane8.addItem(guiItem8);
                    gui.addPane((Pane)pane8);
                    ...
                    GuiItem guiItem9 = new GuiItem(item9, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_10, player);
                    });
                    pane9.addItem(guiItem9);
                    gui.addPane((Pane)pane9);
                    ...
                    GuiItem guiItem10 = new GuiItem(item10, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_11, player);
                    });
                    pane10.addItem(guiItem10);
                    gui.addPane((Pane)pane10);
                    ...
                    GuiItem guiItem12 = new GuiItem(item12, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_12, player);
                    });
                    pane12.addItem(guiItem12);
                    gui.addPane((Pane)pane12);
                    ...
                    GuiItem guiItem13 = new GuiItem(item13, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_13, player);
                    });
                    pane14.addItem(guiItem13);
                    gui.addPane((Pane)pane14);
                    ...
                    GuiItem guiItem14 = new GuiItem(item14, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_14, player);
                    });
                    ...
                    GuiItem guiItem15 = new GuiItem(item15, event -> {
                        player.closeInventory();
                        pickBanTime(args[0], Reason_15, player);
                    });
                    pane16.addItem(guiItem15);
                    gui.addPane((Pane)pane16);
        ...
        if (command.getName().equals("newmute"))
            if (args.length > 0) {
                ...
                if (player.hasPermission("Gui.punish.mute")) {
                    Gui gui = new Gui((Plugin)this, 3, "Mute: " + args[0]);
                    ...
                    GuiItem guiItem = new GuiItem(item, event -> {
                        player.closeInventory();
                        pickMuteTime(args[0], Reason_1, player);
                    });
                    pane.addItem(guiItem);
                    gui.addPane((Pane)pane);
                    ...
                    GuiItem guiItem1 = new GuiItem(item1, event -> {
                        player.closeInventory();
                        pickMuteTime(args[0], Reason_2, player);
                    });
                    pane1.addItem(guiItem1);
                    gui.addPane((Pane)pane1);
                    ...
                    GuiItem guiItem2 = new GuiItem(item2, event -> {
                        player.closeInventory();
                        pickMuteTime(args[0], Reason_3, player);
                    });
                    pane2.addItem(guiItem2);
                    gui.addPane((Pane)pane2);
                    ...
                    GuiItem guiItem3 = new GuiItem(item3, event -> {
                        player.closeInventory();
                        pickMuteTime(args[0], Reason_4, player);
                    });
                    pane3.addItem(guiItem3);
                    gui.addPane((Pane)pane3);
                    ...
                    GuiItem guiItem4 = new GuiItem(item4, event -> {
                        player.closeInventory();
                        pickMuteTime(args[0], Reason_5, player);
                    });
                    pane4.addItem(guiItem4);
                    gui.addPane((Pane)pane4);
                    String Reason_6 = "Back";
        ...
        if (command.getName().equals("punish"))
            if (args.length > 0) {
                ...
                Player player = (Player)sender;
                if (player.hasPermission("Gui.punish")) {
                    Gui guiiii = new Gui((Plugin)this, 3, "Punish " + args[0]);
        ...
        if (command.getName().equals("pardon"))
            if (args.length > 0) {
                ...
                if (player.hasPermission("Gui.pardon")) {
                    Gui guiii = new Gui((Plugin)this, 3, "Pardon " + args[0]);
